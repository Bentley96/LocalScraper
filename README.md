...
To publish a new release, go to **Actions → Build desktop app → Run workflow**, type a version
such as `v1.1.0` and click **Run workflow**. Leave the version empty to just build.
